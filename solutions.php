              ...
              <div class="compartment">
                ...
                <div class="silk-harmonica silk-harmonica--expanded silk-harmonica--solutions">
                  <header role="tab" class="silk-harmonica__header"> 
                    ...
                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/drilling.jpg" alt="undefined">
                    </figure>
                  </header>
                  ...
                  <header role="tab" class="silk-harmonica__header"> 
                    ...
                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/surgery.jpg" alt="undefined">
                    </figure>
                  </header>
                  <article role="tabpanel" class="silk-harmonica__content"> 
                    <h2>Our Solution</h2>
                  ...
                  <header role="tab" class="silk-harmonica__header"> 
                    ...
                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/room.jpg" alt="undefined">
                    </figure>
                  </header>
                  <article role="tabpanel" class="silk-harmonica__content"> 
                    <h2>Our Solution</h2>
                  ...
                  <header role="tab" class="silk-harmonica__header"> 
                    ...
                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hands.jpg" alt="undefined">
                    </figure>
                  </header>
                  <article role="tabpanel" class="silk-harmonica__content"> 
                    <h2>Our Solution</h2>
