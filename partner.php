            ...
            <div class="section">
              <div class="compartment">
                <div class="flex flex--justified flex--start">
                  <h1>Partner Page</h1><a href="" class="button button--mini"><span>Share</span>
                ...
                <figure class="shifted-asset shifted-asset--left shifted-asset--outlined"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/partner.jpg"></figure>
                <h3>Header Lorem Ipsum Dolor</h3>
                <p>Praesent semper acus vitae malesuada congue. Morbi vehicula mi quis felis congue, sit amet faucibus ipsum vehicula. Suspendisse fringilla, ipsum eleifend leo fringilla auctor. Nam commodo lacus vitae malesuada congue. Morbi vehicula mi quis felis congue, sit amet faucibus ipsum vehicula. Suspendisse fringilla, risus id vehicula venenatis, velit velit tristique nulla, id congue, sit amet faucibus ipsum <a href="">In Text Link</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vitae ligula dolor. Praesent semper ipsum eleifend leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vitae ligula dolor. Praesent semper ipsum eleifend leo fringilla auctor. Nam commodo lacus vitae malesuada congue. Morbi vehicula mi quis felis congue, sit amet faucibus ipsum vehicula. Suspendisse fringilla, risus id vehicula venenatis, velit velit tristique nulla, id congue, sit amet faucibus ipsum <a href="">In Text Link</a> justo.</p>
                <h2>Product Listing</h2>
                <div class="silk-harmonica silk-harmonica--condensed">
                  <header role="tab" class="silk-harmonica__header"> 
                    <h3>Lorem Ipsum Dolor Sit Amer, Consectetur</h3>
                  </header>
                  <article role="tabpanel" class="silk-harmonica__content"> 
                    <figure class="shifted-asset shifted-asset--left"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/inkjet.jpg"></figure>
              ...
              <div class="grid grid--40">
                <div class="col-yatterman-4"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/printer.jpg" class="full-width titled-image">
                  <h3>Header Lorem Ipsum dolor</h3>
                ...
                <div class="col-yatterman-4"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/items.jpg" class="full-width titled-image">
                  <h3>Header Lorem Ipsum dolor</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vitae ligula dolor. Praesent semper ipsum eleifend leo fringilla auctor. Nam</p>
                </div>
                <div class="col-yatterman-4"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/items.jpg" class="full-width titled-image">
