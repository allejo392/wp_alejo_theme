<footer class="site__footer">
        ...
        <div class="tread">
          <nav class="nav nav-secondary-main">
            <ul>
              ...
              <li><a href="./business-areas">Business Areas</a>
                <ul>
                  <li><a href="/">Dropdown</a></li>
                  <li><a href="/">Dropdown</a></li>
                </ul>
    ...
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/build/main.js"></script>
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/build/site.js"></script>
  </body>
</html>